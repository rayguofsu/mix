221. Maximal Square
Total Accepted: 21341 Total Submissions: 96016 Difficulty: Medium
...
//t[i][j] = min(t[i][j-1], t[i-1][j], t[i-1][j-1]) + 1. // t[i][j] represents the length of the square that can be formed so far including the element t[i][j] in the square
